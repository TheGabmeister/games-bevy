...
pub struct RoomDef {
    ...
    pub interior_walls: Vec<WallRect>,
}
    ...
    pub fn new() -> Self {
        let rooms = vec![
            RoomDef {
                ...
                interior_walls: vec![
                    WallRect::new(-200.0, 0.0, 40.0, 200.0),
                    WallRect::new(200.0, 0.0, 40.0, 200.0),
                ],
            },
            RoomDef {
            ...
            RoomDef {
                ...
                gates: [None, None, None, None],
                interior_walls: vec![
                    WallRect::new(0.0, 80.0, 200.0, 20.0),
                    WallRect::new(0.0, -80.0, 200.0, 20.0),
                ],
            },
            RoomDef {
                ...
                gates: [None, None, None, None],
                interior_walls: vec![
                    WallRect::new(-150.0, 50.0, 30.0, 120.0),
                    WallRect::new(50.0, -50.0, 30.0, 120.0),
                    WallRect::new(150.0, 100.0, 30.0, 80.0),
                ],
            },
            RoomDef {
                name: "RED COURTYARD",
                ...
                interior_walls: vec![
                    WallRect::new(-100.0, 0.0, 20.0, 150.0),
                    WallRect::new(100.0, 0.0, 20.0, 150.0),
                ],
            },
            RoomDef {
                ...
                gates: [None, None, None, None],
                interior_walls: vec![
                    WallRect::new(-180.0, 0.0, 40.0, 180.0),
                    WallRect::new(180.0, 0.0, 40.0, 180.0),
                ],
            },
            RoomDef {
                ...
                gates: [None, None, None, None],
                interior_walls: vec![WallRect::new(0.0, 0.0, 20.0, 150.0)],
            },
            RoomDef {
                name: "BLUE MAZE",
                ...
                gates: [None, None, None, None],
                interior_walls: vec![
                    WallRect::new(-100.0, 80.0, 160.0, 20.0),
                    WallRect::new(80.0, -40.0, 160.0, 20.0),
                    WallRect::new(-80.0, -120.0, 160.0, 20.0),
                ],
            },
            RoomDef {
                ...
                gates: [None, None, None, None],
                interior_walls: vec![WallRect::new(0.0, 60.0, 200.0, 20.0)],
            },
            RoomDef {
                ...
                interior_walls: vec![
                    WallRect::new(-120.0, 0.0, 20.0, 120.0),
                    WallRect::new(120.0, 0.0, 20.0, 120.0),
                ],
            },
            RoomDef {
                ...
                gates: [None, None, None, None],
                interior_walls: vec![
                    WallRect::new(-160.0, 0.0, 40.0, 200.0),
                    WallRect::new(160.0, 0.0, 40.0, 200.0),
                ],
            },
            RoomDef {
            ...
            RoomDef {
                ...
                gates: [None, None, None, None],
                interior_walls: vec![WallRect::new(0.0, 0.0, 20.0, 120.0)],
            },
            RoomDef {
...
pub fn build_room_walls(room: &RoomDef) -> Vec<WallRect> {
    ...
    walls.extend_from_slice(&room.interior_walls);
